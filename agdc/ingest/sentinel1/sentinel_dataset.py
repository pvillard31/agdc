...
from .sentinel_bandstack import SentinelBandstack
...
class SentinelDataset(AbstractDataset):
    ...
    def __init__(self, dataset_path):
        ...
        self._satellite_tag = "S1"
        self._satellite_sensor = "Sentinel_1"
        ...
        self._ds = gdal.Open(self._dataset_file, gdal.GA_ReadOnly)
        ...
        self._completion_datetime = tree.xpath("/product/adsHeader/startTime")[0].text.replace('T', ' ')
        ...
        self._mtl_text = None
        self._processor_level = "Range_Doppler_Terrain_Correction"
    ...
    def stack_bands(self, band_dict):
        ...
        bands into tiles.
        """
        return SentinelBandstack(self, band_dict)
